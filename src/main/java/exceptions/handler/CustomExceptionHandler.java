...
//    @ExceptionHandler(CountryCreateException.class)
//    private String handleHotelCreateException(HttpServletRequest request, Exception exception) {
//        log.error(exception.getMessage());
//        request.setAttribute("error", exception.getMessage());
//        return "manager_action/create_country";
//    }

//    @ExceptionHandler(HotelCreateException.class)
//    private String handleHotelCreateException(HttpServletRequest request, Exception exception) {
//        log.error(exception.getMessage());
//        request.setAttribute("error", exception.getMessage());
